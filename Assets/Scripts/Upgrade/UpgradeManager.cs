...
{
    /// <summary>Scene bootstrap that owns the single <see cref="UpgradeService"/> instance and publishes it via <see cref="ManagementBonuses"/>.</summary>
    ...
    public sealed class UpgradeManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            ManagementBonuses.Current = Service;
